...
(function(b) {
    ...
    d.prototype = {
        ...
        _setTooltipPos: function(e, j) {
            ...
            c = a.fitInRange(c, 0, f - h);
            d.x = a.fitInRange(d.x, 0, g - i);
            this.tooltip.stop();
        ...
        _highlightShapes: function(g) {
            ...
            var f = this.options.tooltips,
                a = [];
            b.each(g, function(d, c) {
                var b = c._createHighlightShape(f.highlightingFillStyle, f.highlightingStrokeStyle);
                a.push(b)
            });
            var c;
            if (a.length == 1) {
            ...
            var e = new b.Event("dataHighlighting");
    ...
    f.prototype.render = function(b, k) {
        if (!this.visible) return;
        c.prototype.render.call(this, b, k);
        var h = this.strokeStyle != null && this.lineWidth > 0,
            j = h && Math.floor(this.lineWidth % 2) ? a.roundH : Math.round,
            i = this.correction || 0;
        i = Math.round(i);
        var f = j(this.x),
            g = j(this.y),
        ...
        if (e <= 0 || d <= 0) return;
        if (this.cornerRadius == 0) this.renderRectPath(b, f, g, e, d);
        else this.renderRoundedRectPath(b, f, g, e, d);
    ...
    q.prototype.render = function(e, g) {
        ...
        if (!a.isNull(this.length)) {
            ...
            b = this._getAnimationPoints(b, h)
        }
        var f = b.length;
        if (f <= 2) return;
        if (this.xOffset) {
            b = b.slice(0);
            for (var d = 0; d < b.length; d += 2) b[d] += this.xOffset
        }
        if (this.yOffset) {
            b = b.slice(0);
            for (var d = 1; d < b.length; d += 2) b[d] += this.yOffset
        }
        e.beginPath();
        e.moveTo(b[0], b[1]);
    ...
    e.prototype.render = function(e, h) {
        if (!this.visible) return;
        ...
        var f = Math.floor(this.lineWidth % 2) ? a.roundH : Math.round;
        if (this.dontRound) f = function(a) {
            return a
        };
        e.beginPath();
        e.moveTo(f(b[0]), f(b[1]));
        for (var d = 2; d < g; d += 2) e.lineTo(f(b[d]), f(b[d + 1]));
        e.closePath();
