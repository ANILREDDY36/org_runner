...
(function(window, document, $, undefined) {
    ...
    $(function() {
        ...
        $('#chk-collapsed-text').prop('checked', $body.addClass('aside-collapsed-text'));
...
(function(window, document, $, undefined){
  ...
  //   if ( $(".nav-floating").length == 0 )
  //     return false;  
  //   if( $(e.relatedTarget).closest('.sidebar').length == 0 && $(e.relatedTarget).closest('.sidebar-subnav').length == 0){  
  //     $(".nav-floating").remove();  
  //   }  
  // })
